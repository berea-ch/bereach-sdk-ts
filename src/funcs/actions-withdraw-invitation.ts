...
export function actionsWithdrawInvitation(
  ...
  Result<
    operations.WithdrawInvitationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.WithdrawInvitationRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.WithdrawInvitationResponse$inboundSchema),
