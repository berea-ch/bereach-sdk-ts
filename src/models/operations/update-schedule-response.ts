...
import {
  ...
  UpdateLifecycleStage$outboundSchema,
  UpdateOutreachStatus,
  UpdateOutreachStatus$outboundSchema,
} from "./update-outreach-status.js";
...
export const ListMessagesStatusResponse = {
  Draft: "draft",
  Scheduled: "scheduled",
  Sending: "sending",
  Sent: "sent",
...
export type ListMessagesStatusResponse = OpenEnum<
  typeof ListMessagesStatusResponse
>;
...
export type ListMessagesMessage = {
  ...
  message: string;
  status: ListMessagesStatusResponse;
...
export type CreateStatusResponse = OpenEnum<typeof CreateStatusResponse>;
...
/** @internal */
export const ListMessagesStatusResponse$inboundSchema: z.ZodMiniType<
  ListMessagesStatusResponse,
  unknown
> = openEnums.inboundSchema(ListMessagesStatusResponse);
...
> = z.object({
  ...
  status: ListMessagesStatusResponse$inboundSchema,
...
/** @internal */
export const ListMessagesPagination$inboundSchema: z.ZodMiniType<
...
export function listMessagesPaginationFromJSON(
  jsonString: string,
): SafeParseResult<ListMessagesPagination, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ListMessagesPagination$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ListMessagesPagination' from JSON`,
  );
}
...
> = z.object({
  ...
  pagination: z.lazy(() => ListMessagesPagination$inboundSchema),
  creditsUsed: types.number(),
  retryAfter: types.number(),
});
...
/** @internal */
export const CreateStatusResponse$inboundSchema: z.ZodMiniType<
  CreateStatusResponse,
  unknown
> = openEnums.inboundSchema(CreateStatusResponse);

/** @internal */
export const CreateMessage$inboundSchema: z.ZodMiniType<
  CreateMessage,
  unknown
> = z.object({
  id: types.string(),
  ...
  contactLinkedinUrl: types.nullable(types.string()),
  message: types.string(),
  status: CreateStatusResponse$inboundSchema,
  scheduledSendAt: types.nullable(types.string()),
  sentAt: types.nullable(types.string()),
  campaignSlug: types.nullable(types.string()),
  createdAt: types.string(),
...
> = z.object({
  success: types.literal(true),
  message: z.lazy(() => CreateMessage$inboundSchema),
  creditsUsed: types.number(),
  retryAfter: types.number(),
});
