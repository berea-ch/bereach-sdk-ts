...
```typescript
import { GetProfileMedia } from "bereach/models/operations";

let value: GetProfileMedia = {
  type: "document",
  urls: [
    "<value 1>",
  ],
...
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `type`                                                                              | [operations.GetProfileMediaType](../../models/operations/get-profile-media-type.md) | :heavy_check_mark:                                                                  | Type of media attached to the post.                                                 |
