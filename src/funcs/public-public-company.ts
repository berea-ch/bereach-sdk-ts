 ...
 */
export function publicPublicCompany(
  client: BereachCore,
  request: operations.PublicCompanyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PublicCompanyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.PublicCompanyRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/public/company")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PublicCompanyResponse$inboundSchema),
