...
import { profileListRecommendedPeople } from "../funcs/profile-list-recommended-people.js";
...
export class Profile extends ClientSDK {
  ...
  /**
   * List the people LinkedIn recommends
   *
   * @remarks
   ...
   */
  async listRecommendedPeople(
    request?: operations.GetRecommendedPeopleRequest | undefined,
    options?: RequestOptions,
  ): Promise<operations.GetRecommendedPeopleResponse> {
    return unwrapAsync(profileListRecommendedPeople(
      this,
      request,
      options,
    ));
