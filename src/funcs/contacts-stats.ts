...
export function contactsStats(
  ...
  Result<
    operations.ContactsStatsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ContactsStatsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/contacts/stats")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ContactsStatsResponse$inboundSchema),
