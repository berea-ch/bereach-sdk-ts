...
```typescript
import { GetMyLinkedInProfileMedia } from "bereach/models/operations";

let value: GetMyLinkedInProfileMedia = {
  type: "video",
  urls: [],
};
```
...
| ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `type`                                                                                                     | [operations.GetMyLinkedInProfileMediaType](../../models/operations/get-my-linked-in-profile-media-type.md) | :heavy_check_mark:                                                                                         | Type of media attached to the post.                                                                        |
