...
export function actionsConnectProfile(
  ...
  Result<
    operations.ConnectProfileResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ConnectProfileRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ConnectProfileResponse$inboundSchema),
