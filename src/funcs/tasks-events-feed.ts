 ...
 */
export function tasksEventsFeed(
  client: BereachCore,
  request?: operations.EventsFeedRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.EventsFeedResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.EventsFeedRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.EventsFeedResponse$inboundSchema),
