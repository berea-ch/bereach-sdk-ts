...
```typescript
import { CollectPostsMedia } from "bereach/models/operations";

let value: CollectPostsMedia = {
  type: "article",
  urls: [
    "<value 1>",
    "<value 2>",
...
| --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| `type`                                                                                  | [operations.CollectPostsMediaType](../../models/operations/collect-posts-media-type.md) | :heavy_check_mark:                                                                      | Type of media attached to the post.                                                     |
