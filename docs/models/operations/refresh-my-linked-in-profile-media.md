...
```typescript
import { RefreshMyLinkedInProfileMedia } from "bereach/models/operations";

let value: RefreshMyLinkedInProfileMedia = {
  type: "document",
  urls: [],
};
```
...
| ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| `type`                                                                                                             | [operations.RefreshMyLinkedInProfileMediaType](../../models/operations/refresh-my-linked-in-profile-media-type.md) | :heavy_check_mark:                                                                                                 | Type of media attached to the post.                                                                                |
