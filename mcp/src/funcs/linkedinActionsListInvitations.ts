...
import {
  ...
  ListLinkedInInvitationsRequest$zodSchema,
} from "../models/listlinkedininvitationsop.js";
...
export function linkedinActionsListInvitations(
  ...
  request?: ListLinkedInInvitationsRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      ListLinkedInInvitationsRequest$zodSchema.optional().parse(value$),
