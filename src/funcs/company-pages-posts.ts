 ...
 */
export function companyPagesPosts(
  client: BereachCore,
  request: operations.CompanyPagePostsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CompanyPagePostsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CompanyPagePostsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CompanyPagePostsResponse$inboundSchema),
