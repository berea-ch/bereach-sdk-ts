...
```typescript
import { GetMyLinkedInPostsMedia } from "bereach/models/operations";

let value: GetMyLinkedInPostsMedia = {
  type: "image",
  urls: [],
};
```
...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| `type`                                                                                                 | [operations.GetMyLinkedInPostsMediaType](../../models/operations/get-my-linked-in-posts-media-type.md) | :heavy_check_mark:                                                                                     | Type of media attached to the post.                                                                    |
