 ...
 */
export function searchResolveProfiles(
  client: BereachCore,
  request: operations.ResolveProfilesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ResolveProfilesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ResolveProfilesRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/resolve/linkedin/profiles")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ResolveProfilesResponse$inboundSchema),
