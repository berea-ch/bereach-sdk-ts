...
```typescript
import { VisitLinkedInProfileMedia } from "bereach/models/operations";

let value: VisitLinkedInProfileMedia = {
  type: "image",
  urls: [
    "<value 1>",
    "<value 2>",
...
| --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| `type`                                                                                                    | [operations.VisitLinkedInProfileMediaType](../../models/operations/visit-linked-in-profile-media-type.md) | :heavy_check_mark:                                                                                        | Type of media attached to the post.                                                                       |
