...
import {
  ...
  ListInboxConversationsRequest$zodSchema,
} from "../models/listinboxconversationsop.js";
 ...
 */
export function linkedinChatListConversations(
  client$: BereachSDKCore,
  request: ListInboxConversationsRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListInboxConversationsRequest$zodSchema.parse(value$),
