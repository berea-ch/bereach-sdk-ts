 ...
 */
export function profileGetMyPosts(
  client: BereachCore,
  request?: operations.GetOwnPostsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetOwnPostsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.GetOwnPostsRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetOwnPostsResponse$inboundSchema),
