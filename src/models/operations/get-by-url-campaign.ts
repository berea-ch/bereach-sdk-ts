...
/** @internal */
export const GlobalActivitiesRequest$outboundSchema: z.ZodMiniType<
  GlobalActivitiesRequest$Outbound,
...
export function globalActivitiesRequestToJSON(
  globalActivitiesRequest: GlobalActivitiesRequest,
): string {
  return JSON.stringify(
    GlobalActivitiesRequest$outboundSchema.parse(globalActivitiesRequest),
  );
}

/** @internal */
export const GlobalActivitiesActivity$inboundSchema: z.ZodMiniType<
  GlobalActivitiesActivity,
  unknown
> = z.object({
  id: types.string(),
  type: types.string(),
...
export function globalActivitiesActivityFromJSON(
  jsonString: string,
): SafeParseResult<GlobalActivitiesActivity, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GlobalActivitiesActivity$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GlobalActivitiesActivity' from JSON`,
  );
}

/** @internal */
export const GlobalActivitiesPagination$inboundSchema: z.ZodMiniType<
  GlobalActivitiesPagination,
  unknown
> = z.object({
  limit: types.number(),
  offset: types.number(),
...
export function globalActivitiesPaginationFromJSON(
  jsonString: string,
): SafeParseResult<GlobalActivitiesPagination, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GlobalActivitiesPagination$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GlobalActivitiesPagination' from JSON`,
  );
}

/** @internal */
export const GlobalActivitiesResponse$inboundSchema: z.ZodMiniType<
...
export function globalActivitiesResponseFromJSON(
  jsonString: string,
): SafeParseResult<GlobalActivitiesResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GlobalActivitiesResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GlobalActivitiesResponse' from JSON`,
  );
}
