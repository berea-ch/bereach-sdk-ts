 ...
 */
export function publicPublicFindCompanies(
  client: BereachCore,
  request: operations.PublicFindCompaniesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PublicFindCompaniesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.PublicFindCompaniesRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/public/companies")();
  ...
  const context = {
    ...
    operationID: "publicFindCompanies",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PublicFindCompaniesResponse$inboundSchema),
