...
| `followersCount`                                                                      | *number*                                                                              | :heavy_minus_sign:                                                                    | Total number of followers (populated during refresh)                                  |
...
| `lastComments`                                                                        | *any*[]                                                                               | :heavy_minus_sign:                                                                    | Last 20 comments by the user (populated after /me/linkedin/activity?tabType=COMMENTS) |
| `lastReactions`                                                                       | *any*[]                                                                               | :heavy_minus_sign:                                                                    | Last reactions by the user (populated after /me/linkedin/activity?tabType=REACTIONS)  |
