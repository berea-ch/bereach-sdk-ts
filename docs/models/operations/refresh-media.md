...
```typescript
import { RefreshMedia } from "bereach/models/operations";

let value: RefreshMedia = {
  type: "article",
  urls: [
    "<value 1>",
  ],
...
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `type`                                                                          | [operations.RefreshMediaType](../../models/operations/refresh-media-type.md)    | :heavy_check_mark:                                                              | Type of media attached to the post.                                             |
