...
import {
  ...
  GetMyLinkedInPostsRequest$zodSchema,
} from "../models/getmylinkedinpostsop.js";
 ...
 */
export function profileGetPosts(
  client$: BereachSDKCore,
  request?: GetMyLinkedInPostsRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetMyLinkedInPostsRequest$zodSchema.optional().parse(value$),
