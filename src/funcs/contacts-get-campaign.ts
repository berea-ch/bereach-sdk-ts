 ...
 */
export function contactsGetCampaign(
  client: BereachCore,
  request: operations.GetCampaignRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetCampaignResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetCampaignRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCampaignResponse$inboundSchema),
