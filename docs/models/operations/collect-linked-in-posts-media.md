...
```typescript
import { CollectLinkedInPostsMedia } from "bereach/models/operations";

let value: CollectLinkedInPostsMedia = {
  type: "video",
  urls: [],
};
```
...
| --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| `type`                                                                                                    | [operations.CollectLinkedInPostsMediaType](../../models/operations/collect-linked-in-posts-media-type.md) | :heavy_check_mark:                                                                                        | Type of media attached to the post.                                                                       |
