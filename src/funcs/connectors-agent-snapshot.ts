 ...
 */
export function connectorsAgentSnapshot(
  client: BereachCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AgentSnapshotResponse,
...
> {
  const path = pathToFunc("/agent/snapshot")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AgentSnapshotResponse$inboundSchema),
