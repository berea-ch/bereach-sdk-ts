...
```typescript
import { GetMyPostsMedia } from "bereach/models/operations";

let value: GetMyPostsMedia = {
  type: "video",
  urls: [
    "<value 1>",
    "<value 2>",
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `type`                                                                               | [operations.GetMyPostsMediaType](../../models/operations/get-my-posts-media-type.md) | :heavy_check_mark:                                                                   | Type of media attached to the post.                                                  |
