...
export function profileGetSearchAppearances(
  client: BereachCore,
  _request?: operations.GetSearchAppearancesRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetSearchAppearancesResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "getSearchAppearances",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSearchAppearancesResponse$inboundSchema),
