...
export function linkedInActionsDeclineInvitation(
  ...
  Result<
    operations.DeclineInvitationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeclineInvitationRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeclineInvitationResponse$inboundSchema),
