 ...
 */
export function contactsGetByUrl(
  client: BereachCore,
  request: operations.ContactsGetByUrlRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ContactsGetByUrlResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ContactsGetByUrlRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/contacts/by-url")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ContactsGetByUrlResponse$inboundSchema),
