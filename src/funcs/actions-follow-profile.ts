...
export function actionsFollowProfile(
  ...
  Result<
    operations.FollowProfileResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.FollowProfileRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.FollowProfileResponse$inboundSchema),
