...
```typescript
import { SearchMedia } from "bereach/models/operations";
...
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `type`                                                                          | [operations.SearchMediaType](../../models/operations/search-media-type.md)      | :heavy_check_mark:                                                              | Type of media attached to the post.                                             |
