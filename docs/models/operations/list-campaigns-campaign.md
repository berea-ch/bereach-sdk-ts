...
```typescript
import { ListCampaignsCampaign } from "bereach/models/operations";

let value: ListCampaignsCampaign = {
  id: "<id>",
  name: "<value>",
  description: "thump stir-fry briskly amongst whenever developing",
  context: "<value>",
  type: "<value>",
  status: "<value>",
  totalContacts: 227274,
  createdAt: "1729161920227",
  updatedAt: "1735631428680",
};
```
...
| `stageCounts`                                                                                 | [operations.ListCampaignsStageCounts](../../models/operations/list-campaigns-stage-counts.md) | :heavy_minus_sign:                                                                            | N/A                                                                                           |
