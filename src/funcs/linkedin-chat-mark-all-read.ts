 ...
 */
export function linkedinChatMarkAllRead(
  client: BereachCore,
  _request?: operations.MarkAllReadRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MarkAllReadResponse,
...
> {
  const path = pathToFunc("/chats/linkedin/mark-all-read")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MarkAllReadResponse$inboundSchema),
