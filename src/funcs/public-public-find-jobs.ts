 ...
 */
export function publicPublicFindJobs(
  client: BereachCore,
  request: operations.PublicFindJobsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PublicFindJobsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.PublicFindJobsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/public/jobs")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PublicFindJobsResponse$inboundSchema),
