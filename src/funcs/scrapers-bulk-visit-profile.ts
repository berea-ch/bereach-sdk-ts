 ...
 */
export function scrapersBulkVisitProfile(
  client: BereachCore,
  request: operations.BulkVisitProfileRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BulkVisitProfileResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.BulkVisitProfileRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/visit/linkedin/profile/bulk")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.BulkVisitProfileResponse$inboundSchema),
