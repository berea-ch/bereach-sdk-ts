...
export function workspaceCreateWorkspaceInvite(
  ...
  Result<
    operations.CreateWorkspaceInviteResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateWorkspaceInviteRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateWorkspaceInviteResponse$inboundSchema),
