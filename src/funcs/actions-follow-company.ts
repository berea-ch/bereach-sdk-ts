...
export function actionsFollowCompany(
  ...
  Result<
    operations.FollowCompanyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.FollowCompanyRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.FollowCompanyResponse$inboundSchema),
