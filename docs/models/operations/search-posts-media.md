...
```typescript
import { SearchPostsMedia } from "bereach/models/operations";

let value: SearchPostsMedia = {
  type: "article",
  urls: [
    "<value 1>",
  ],
...
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `type`                                                                                | [operations.SearchPostsMediaType](../../models/operations/search-posts-media-type.md) | :heavy_check_mark:                                                                    | Type of media attached to the post.                                                   |
