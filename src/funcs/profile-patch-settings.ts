 ...
 */
export function profilePatchSettings(
  client: BereachCore,
  request: operations.PatchSettingsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PatchSettingsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.PatchSettingsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/me/settings")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PatchSettingsResponse$inboundSchema),
