 ...
 */
export function contactsBulkUpdate(
  client: BereachCore,
  request: operations.BulkUpdateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BulkUpdateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.BulkUpdateRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.BulkUpdateResponse$inboundSchema),
