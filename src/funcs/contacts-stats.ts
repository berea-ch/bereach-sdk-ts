...
export function contactsStats(
  ...
  Result<
    operations.GetContactStatsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetContactStatsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetContactStatsResponse$inboundSchema),
