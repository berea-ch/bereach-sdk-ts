 ...
 */
export function linkedinScrapersCollectHashtagPosts(
  client: BereachCore,
  request: operations.CollectHashtagPostsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CollectHashtagPostsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CollectHashtagPostsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/collect/linkedin/hashtag")();
  ...
  const context = {
    ...
    operationID: "collectHashtagPosts",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CollectHashtagPostsResponse$inboundSchema),
