...
* [listConversations](#listconversations) - List LinkedIn inbox conversations
...
async function run() {
  const result = await bereach.linkedinChat.listConversations({});
...
import { linkedinChatListConversations } from "bereach/funcs/linkedin-chat-list-conversations.js";
...
async function run() {
  const res = await linkedinChatListConversations(bereach, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("linkedinChatListConversations failed:", res.error);
  }
}
...
async function run() {
  const result = await bereach.linkedinChat.searchConversations({
...
```typescript
import { BereachCore } from "bereach/core.js";
import { linkedinChatSearchConversations } from "bereach/funcs/linkedin-chat-search-conversations.js";
...
async function run() {
  const res = await linkedinChatSearchConversations(bereach, {
    keywords: "project update",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("linkedinChatSearchConversations failed:", res.error);
  }
}
...
async function run() {
  const result = await bereach.linkedinChat.findConversation({
...
```typescript
import { BereachCore } from "bereach/core.js";
import { linkedinChatFindConversation } from "bereach/funcs/linkedin-chat-find-conversation.js";
...
async function run() {
  const res = await linkedinChatFindConversation(bereach, {
    profile: "https://linkedin.com/in/marie-sandre",
    includeMessages: true,
  });
  if (res.ok) {
    ...
    console.log("linkedinChatFindConversation failed:", res.error);
  }
}
