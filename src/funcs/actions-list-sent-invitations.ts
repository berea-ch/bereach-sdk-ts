...
export function actionsListSentInvitations(
  ...
  Result<
    operations.ListSentInvitationsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListSentInvitationsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSentInvitationsResponse$inboundSchema),
