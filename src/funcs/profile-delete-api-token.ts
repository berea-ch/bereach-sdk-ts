 ...
 */
export function profileDeleteApiToken(
  client: BereachCore,
  request?: operations.DeleteApiTokenRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteApiTokenResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.DeleteApiTokenRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteApiTokenResponse$inboundSchema),
