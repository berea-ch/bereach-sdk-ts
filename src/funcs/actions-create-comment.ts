...
export function actionsCreateComment(
  ...
  Result<
    operations.CommentOnPostResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CommentOnPostRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CommentOnPostResponse$inboundSchema),
