...
export const toolNames: Array<{ name: string; description: string }>= [
  ...
  {
    "name": "linkedin-search-search-jobs",
  ...
  {
    "name": "linkedin-actions-send-message",
  ...
  {
    "name": "profile-get-linked-in-profile",
