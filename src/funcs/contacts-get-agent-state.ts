 ...
 */
export function contactsGetAgentState(
  client: BereachCore,
  request: operations.GetAgentStateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetAgentStateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetAgentStateRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAgentStateResponse$inboundSchema),
