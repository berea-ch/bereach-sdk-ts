 ...
 */
export function profileSwitchAccount(
  client: BereachCore,
  request: operations.SwitchAccountRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SwitchAccountResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.SwitchAccountRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/me/switch-account")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SwitchAccountResponse$inboundSchema),
