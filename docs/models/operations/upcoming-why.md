...
| ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| `status`                                                                                                      | [operations.UpcomingStatus](../../models/operations/upcoming-status.md)                                       | :heavy_check_mark:                                                                                            | next is first in line, not sent; waiting names the place or the reason; blocked means the account is stopped. |
| `detail`                                                                                                      | *string*                                                                                                      | :heavy_check_mark:                                                                                            | A plain sentence about the wait, safe to show as written.                                                     |
