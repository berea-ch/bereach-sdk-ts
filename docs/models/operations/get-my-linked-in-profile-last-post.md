...
| `media`                                                                                             | [operations.GetMyLinkedInProfileMedia](../../models/operations/get-my-linked-in-profile-media.md)   | :heavy_minus_sign:                                                                                  | Media attached to the post (image, video, document, or article). Absent when the post is text-only. |