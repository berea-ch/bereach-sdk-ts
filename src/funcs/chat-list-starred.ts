 ...
 */
export function chatListStarred(
  client: BereachCore,
  request?: operations.ListStarredRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListStarredResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.ListStarredRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListStarredResponse$inboundSchema),
