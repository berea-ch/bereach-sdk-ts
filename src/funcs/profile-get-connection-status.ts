 ...
 */
export function profileGetConnectionStatus(
  client: BereachCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetConnectionStatusResponse,
...
> {
  const path = pathToFunc("/me/connection-status")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetConnectionStatusResponse$inboundSchema),
