...
import {
  ...
  GetMyLinkedInFollowersRequest$zodSchema,
} from "../models/getmylinkedinfollowersop.js";
...
export function profileGetFollowers(
  ...
  request?: GetMyLinkedInFollowersRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      GetMyLinkedInFollowersRequest$zodSchema.optional().parse(value$),
