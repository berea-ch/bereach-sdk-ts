...
```typescript
import { BereachCore } from "bereach/core.js";
import { linkedinScrapersCollectCommentReplies } from "bereach/funcs/linkedin-scrapers-collect-comment-replies.js";
...
async function run() {
  const result = await bereach.linkedinScrapers.collectPosts({
...
```typescript
import { BereachCore } from "bereach/core.js";
import { linkedinScrapersCollectPosts } from "bereach/funcs/linkedin-scrapers-collect-posts.js";
...
async function run() {
  const res = await linkedinScrapersCollectPosts(bereach, {
    profileUrl: "https://www.linkedin.com/in/username",
    count: 20,
    start: 0,
  });
  if (res.ok) {
    ...
    console.log("linkedinScrapersCollectPosts failed:", res.error);
  }
}
...
async function run() {
  const result = await bereach.linkedinScrapers.visitProfile({
...
```typescript
import { BereachCore } from "bereach/core.js";
import { linkedinScrapersVisitProfile } from "bereach/funcs/linkedin-scrapers-visit-profile.js";
...
async function run() {
  const res = await linkedinScrapersVisitProfile(bereach, {
    profile: "https://www.linkedin.com/in/alexandre-sarfati",
    campaignSlug: "lead-magnet-post-12345",
  });
  if (res.ok) {
    ...
    console.log("linkedinScrapersVisitProfile failed:", res.error);
  }
}
