...
import {
  ...
  PublishLinkedInPostRequest$zodSchema,
} from "../models/publishlinkedinpostop.js";
...
export function linkedinActionsPublishPost(
  ...
  request: PublishLinkedInPostRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => PublishLinkedInPostRequest$zodSchema.parse(value$),
