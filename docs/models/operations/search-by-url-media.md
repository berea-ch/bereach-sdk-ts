...
```typescript
import { SearchByUrlMedia } from "bereach/models/operations";

let value: SearchByUrlMedia = {
  type: "article",
  urls: [
    "<value 1>",
    "<value 2>",
...
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| `type`                                                                                 | [operations.SearchByUrlMediaType](../../models/operations/search-by-url-media-type.md) | :heavy_check_mark:                                                                     | Type of media attached to the post.                                                    |
