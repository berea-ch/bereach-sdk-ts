...
export function scheduledMessagesBatchSchedule(
  ...
  Result<
    operations.BatchScheduleResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.BatchScheduleRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.BatchScheduleResponse$inboundSchema),
