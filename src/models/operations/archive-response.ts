...
/** @internal */
export const Proxy$inboundSchema: z.ZodMiniType<Proxy, unknown> = z.catchall(
  z.object({
...
/** @internal */
export const AnthropicKey$inboundSchema: z.ZodMiniType<AnthropicKey, unknown> =
  z.object({
    isSet: types.boolean(),
    partial: types.nullable(types.string()),
  });

export function anthropicKeyFromJSON(
  jsonString: string,
): SafeParseResult<AnthropicKey, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => AnthropicKey$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'AnthropicKey' from JSON`,
  );
}
...
/** @internal */
export const GetSettingsCredits$inboundSchema: z.ZodMiniType<
  GetSettingsCredits,
  unknown
> = z.object({
  current: types.number(),
...
export function getSettingsCreditsFromJSON(
  jsonString: string,
): SafeParseResult<GetSettingsCredits, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetSettingsCredits$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetSettingsCredits' from JSON`,
  );
}
...
/** @internal */
export const RevalidateLinkedinResponse$inboundSchema: z.ZodMiniType<
...
export function revalidateLinkedinResponseFromJSON(
  jsonString: string,
): SafeParseResult<RevalidateLinkedinResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RevalidateLinkedinResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RevalidateLinkedinResponse' from JSON`,
  );
}
