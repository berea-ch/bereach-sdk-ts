 ...
 */
export function profileRevalidateLinkedin(
  client: BereachCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RevalidateLinkedinResponse,
...
> {
  const path = pathToFunc("/me/linkedin/revalidate")();
  ...
  const context = {
    ...
    operationID: "revalidateLinkedin",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RevalidateLinkedinResponse$inboundSchema),
