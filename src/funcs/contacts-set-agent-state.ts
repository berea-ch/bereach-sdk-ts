 ...
 */
export function contactsSetAgentState(
  client: BereachCore,
  request: operations.SetAgentStateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SetAgentStateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.SetAgentStateRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SetAgentStateResponse$inboundSchema),
