...
export function contactsGet(
  ...
  Result<
    operations.ContactsGetFullResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ContactsGetFullRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ContactsGetFullResponse$inboundSchema),
