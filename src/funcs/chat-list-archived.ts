 ...
 */
export function chatListArchived(
  client: BereachCore,
  request?: operations.ListArchivedRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListArchivedResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.ListArchivedRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListArchivedResponse$inboundSchema),
