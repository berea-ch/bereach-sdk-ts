...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.GetMyPostsRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetMyPostsResponse$inboundSchema),
