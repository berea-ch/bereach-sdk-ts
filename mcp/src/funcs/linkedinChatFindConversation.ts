...
import {
  ...
  FindLinkedInConversationRequest$zodSchema,
} from "../models/findlinkedinconversationop.js";
 ...
 */
export function linkedinChatFindConversation(
  client$: BereachSDKCore,
  request: FindLinkedInConversationRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => FindLinkedInConversationRequest$zodSchema.parse(value$),
