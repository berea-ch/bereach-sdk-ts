 ...
 */
export function companyPagesList(
  client: BereachCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListCompanyPagesResponse,
...
> {
  const path = pathToFunc("/me/linkedin/company-pages")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListCompanyPagesResponse$inboundSchema),
