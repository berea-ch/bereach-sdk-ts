...
export type SearchJobsExperienceLevel = ClosedEnum<
  typeof SearchJobsExperienceLevel
>;
...
export type SearchJobsWorkplaceType = ClosedEnum<
  typeof SearchJobsWorkplaceType
>;
...
> = z.enum(SearchJobsDatePosted);

/** @internal */
export const SearchJobsSortBy$outboundSchema: z.ZodMiniEnum<
  typeof SearchJobsSortBy
> = z.enum(SearchJobsSortBy);

/** @internal */
export const SearchJobsJobType$outboundSchema: z.ZodMiniEnum<
  typeof SearchJobsJobType
> = z.enum(SearchJobsJobType);

/** @internal */
export const SearchJobsExperienceLevel$outboundSchema: z.ZodMiniEnum<
  typeof SearchJobsExperienceLevel
> = z.enum(SearchJobsExperienceLevel);

/** @internal */
export const SearchJobsWorkplaceType$outboundSchema: z.ZodMiniEnum<
  typeof SearchJobsWorkplaceType
> = z.enum(SearchJobsWorkplaceType);
...
> = z.object({
  ...
  experienceLevel: z.optional(
    z.array(SearchJobsExperienceLevel$outboundSchema),
  ),
