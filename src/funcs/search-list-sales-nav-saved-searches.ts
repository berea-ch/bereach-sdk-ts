 ...
 */
export function searchListSalesNavSavedSearches(
  client: BereachCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListSalesNavSavedSearchesResponse,
...
> {
  const path = pathToFunc("/search/linkedin/sales-nav/saved-searches")();
  ...
  const context = {
    ...
    operationID: "listSalesNavSavedSearches",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSalesNavSavedSearchesResponse$inboundSchema),
