 ...
 */
export function actionsEditProfile(
  client: BereachCore,
  request: operations.EditProfileRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.EditProfileResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.EditProfileRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/edit/linkedin/profile")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.EditProfileResponse$inboundSchema),
