...
import {
  ...
  GetCampaignStatusRequest$zodSchema,
} from "../models/getcampaignstatusop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetCampaignStatusRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/campaigns/{campaignSlug}/status")(
    pathParams$,
  );
