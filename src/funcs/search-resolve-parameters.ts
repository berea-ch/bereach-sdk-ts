 ...
 */
export function searchResolveParameters(
  client: BereachCore,
  request: operations.ResolveParametersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ResolveParametersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ResolveParametersRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ResolveParametersResponse$inboundSchema),
