...
```typescript
import { GetOwnPostsMedia } from "bereach/models/operations";

let value: GetOwnPostsMedia = {
  type: "image",
  urls: [],
};
```
...
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| `type`                                                                                 | [operations.GetOwnPostsMediaType](../../models/operations/get-own-posts-media-type.md) | :heavy_check_mark:                                                                     | Type of media attached to the post.                                                    |
