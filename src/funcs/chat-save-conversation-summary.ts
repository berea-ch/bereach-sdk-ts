 ...
 */
export function chatSaveConversationSummary(
  client: BereachCore,
  request: operations.SaveConversationSummaryRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SaveConversationSummaryResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.SaveConversationSummaryRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/chats/linkedin/summary")();
  ...
  const context = {
    ...
    operationID: "saveConversationSummary",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SaveConversationSummaryResponse$inboundSchema),
