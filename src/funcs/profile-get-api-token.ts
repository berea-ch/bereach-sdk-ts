 ...
 */
export function profileGetApiToken(
  client: BereachCore,
  request?: operations.GetApiTokenRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiTokenResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.GetApiTokenRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/api-token")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiTokenResponse$inboundSchema),
