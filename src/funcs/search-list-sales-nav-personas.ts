 ...
 */
export function searchListSalesNavPersonas(
  client: BereachCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListSalesNavPersonasResponse,
...
> {
  const path = pathToFunc("/search/linkedin/sales-nav/personas")();
  ...
  const context = {
    ...
    operationID: "listSalesNavPersonas",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSalesNavPersonasResponse$inboundSchema),
