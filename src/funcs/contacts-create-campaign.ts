 ...
 */
export function contactsCreateCampaign(
  client: BereachCore,
  request: operations.ContactsCreateCampaignRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ContactsCreateCampaignResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ContactsCreateCampaignRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/contacts/campaigns")();
  ...
  const context = {
    ...
    operationID: "contactsCreateCampaign",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.ContactsCreateCampaignResponse$inboundSchema),
