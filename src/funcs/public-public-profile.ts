 ...
 */
export function publicPublicProfile(
  client: BereachCore,
  request: operations.PublicProfileRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PublicProfileResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.PublicProfileRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/public/profile")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PublicProfileResponse$inboundSchema),
