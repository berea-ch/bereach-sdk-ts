 ...
 */
export function linkedInChatStar(
  client: BereachCore,
  request: operations.StarRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.StarResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.StarRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/chats/linkedin/star")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.StarResponse$inboundSchema),
