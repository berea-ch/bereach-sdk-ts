 ...
 */
export function searchListSalesNavFilters(
  client: BereachCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListSalesNavFiltersResponse,
...
> {
  const path = pathToFunc("/search/linkedin/sales-nav/filters")();
  ...
  const context = {
    ...
    operationID: "listSalesNavFilters",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSalesNavFiltersResponse$inboundSchema),
