...
import {
  ...
  CollectLinkedInLikesRequest$zodSchema,
} from "../models/collectlinkedinlikesop.js";
...
export function linkedinScrapersCollectLikes(
  ...
  request: CollectLinkedInLikesRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CollectLinkedInLikesRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/collect/linkedin/likes")();
