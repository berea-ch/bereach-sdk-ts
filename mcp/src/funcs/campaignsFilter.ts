...
import {
  ...
  FilterCampaignRequest$zodSchema,
} from "../models/filtercampaignop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => FilterCampaignRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/campaigns/{campaignSlug}/filter")(
    pathParams$,
  );
