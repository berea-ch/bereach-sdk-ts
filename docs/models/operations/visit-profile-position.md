...
let value: VisitProfilePosition = {
  ...
  title: "<value>",
  companyUrl: "https://indelible-summer.info",
  companyLogo: "<value>",
  startDate: {
    month: 435097,
    year: 83382,
...
| `description`                                                                                                    | *string*                                                                                                         | :heavy_minus_sign:                                                                                               | Position description / responsibilities text (always fetched on visit_profile; may be null if LinkedIn has none) |
| `companyUrl`                                                                                                     | *string*                                                                                                         | :heavy_check_mark:                                                                                               | N/A                                                                                                              |
| `companyLogo`                                                                                                    | *string*                                                                                                         | :heavy_check_mark:                                                                                               | N/A                                                                                                              |
| `companyDescription`                                                                                             | *string*                                                                                                         | :heavy_minus_sign:                                                                                               | Short description of the company (always fetched on visit_profile; may be null)                                  |
