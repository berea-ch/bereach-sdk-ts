 ...
 */
export function workspaceDeleteWorkspaceAccount(
  client: BereachCore,
  request: operations.DeleteWorkspaceAccountRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteWorkspaceAccountResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteWorkspaceAccountRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/workspace/accounts/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteWorkspaceAccountResponse$inboundSchema),
