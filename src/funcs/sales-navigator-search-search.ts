 ...
 */
export function salesNavigatorSearchSearch(
  client: BereachCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.SearchSalesNavRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/search/linkedin/sales-nav")();
