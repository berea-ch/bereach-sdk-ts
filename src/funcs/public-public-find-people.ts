 ...
 */
export function publicPublicFindPeople(
  client: BereachCore,
  request: operations.PublicFindPeopleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PublicFindPeopleResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.PublicFindPeopleRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/public/search")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PublicFindPeopleResponse$inboundSchema),
