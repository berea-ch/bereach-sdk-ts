...
let value: GetConnectionStatusResponse = {
  ...
  totals: {
    ...
    accountsWaitingForWindow: 46185,
    accountsBlocked: 968776,
    accountsUnreadable: 108399,
    next: {
      contactId: "<id>",
      name: "<value>",
      avatarUrl: "https://worthy-obedience.biz/",
      headline: "<value>",
      linkedinUrl: "https://prestigious-challenge.net/",
