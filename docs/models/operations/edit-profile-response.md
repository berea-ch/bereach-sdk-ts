...
| `meta`                                                                                                                                    | [operations.EditProfileMeta](../../models/operations/edit-profile-meta.md)                                                                | :heavy_minus_sign:                                                                                                                        | Credit balance carried on every response so a caller never has to ask for it separately. Absent when the caller has no connected account. |