 ...
 */
export function chatGetConversationSummary(
  client: BereachCore,
  request: operations.GetConversationSummaryRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetConversationSummaryResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetConversationSummaryRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetConversationSummaryResponse$inboundSchema),
