...
export function linkedinScrapersListSavedPosts(
  ...
  Result<
    operations.ListSavedPostsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ListSavedPostsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSavedPostsResponse$inboundSchema),
