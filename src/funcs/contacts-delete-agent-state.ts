 ...
 */
export function contactsDeleteAgentState(
  client: BereachCore,
  request: operations.DeleteAgentStateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteAgentStateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteAgentStateRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteAgentStateResponse$inboundSchema),
