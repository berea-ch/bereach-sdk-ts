 ...
 */
export function workspaceDeleteWorkspaceInvite(
  client: BereachCore,
  request: operations.DeleteWorkspaceInviteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteWorkspaceInviteResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteWorkspaceInviteRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/workspace/invites")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteWorkspaceInviteResponse$inboundSchema),
