 ...
 */
export function scrapersBulkVisitBatchStatus(
  client: BereachCore,
  request: operations.BulkVisitBatchStatusRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BulkVisitBatchStatusResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.BulkVisitBatchStatusRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/visit/linkedin/profile/bulk/{batchId}")(pathParams);
  ...
  const context = {
    ...
    operationID: "bulkVisitBatchStatus",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.BulkVisitBatchStatusResponse$inboundSchema),
