 ...
 */
export function publicPublicPostEngagers(
  client: BereachCore,
  request: operations.PublicPostEngagersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PublicPostEngagersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.PublicPostEngagersRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/public/post")();
  ...
  const context = {
    ...
    operationID: "publicPostEngagers",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PublicPostEngagersResponse$inboundSchema),
