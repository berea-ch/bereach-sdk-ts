...
export function linkedinScrapersVisitCompany(
  ...
  Result<
    operations.VisitCompanyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.VisitCompanyRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.VisitCompanyResponse$inboundSchema),
