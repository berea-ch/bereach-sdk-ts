...
import {
  ...
  ScheduledMessageListFirstDmUnion$inboundSchema,
} from "./scheduled-message-list-first-dm-union.js";
...
export type ScheduledMessageListMessage = {
   ...
   */
  firstDm?: ScheduledMessageListFirstDmUnion | undefined;
  /**
   * Where this person's connection request stands, from the invitation lane's own projection. Present on connection_request rows.
   */
...
export type ContextGetResponse = {
  ...
  /**
   * People counts: in the list, removed
   */
...
> = z.object({
  ...
  firstDm: types.optional(ScheduledMessageListFirstDmUnion$inboundSchema),
  invite: z.optional(
