 ...
 */
export function contactsUpdateCampaign(
  client: BereachCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.UpdateCampaignRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateCampaignResponse$inboundSchema),
