 ...
 */
export function profileListRecommendedPeople(
  client: BereachCore,
  request?: operations.GetRecommendedPeopleRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetRecommendedPeopleResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetRecommendedPeopleRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/me/linkedin/recommended")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetRecommendedPeopleResponse$inboundSchema),
