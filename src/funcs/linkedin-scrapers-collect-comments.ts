...
export function linkedinScrapersCollectComments(
  ...
  Result<
    operations.CollectCommentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CollectCommentsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CollectCommentsResponse$inboundSchema),
