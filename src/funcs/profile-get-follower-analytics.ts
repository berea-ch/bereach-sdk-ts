...
export function profileGetFollowerAnalytics(
  client: BereachCore,
  _request?: operations.GetFollowerAnalyticsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetFollowerAnalyticsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetFollowerAnalyticsResponse$inboundSchema),
