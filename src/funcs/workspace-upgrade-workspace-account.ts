 ...
 */
export function workspaceUpgradeWorkspaceAccount(
  client: BereachCore,
  request: operations.UpgradeWorkspaceAccountRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpgradeWorkspaceAccountResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpgradeWorkspaceAccountRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/workspace/accounts/upgrade")();
  ...
  const context = {
    ...
    operationID: "upgradeWorkspaceAccount",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpgradeWorkspaceAccountResponse$inboundSchema),
