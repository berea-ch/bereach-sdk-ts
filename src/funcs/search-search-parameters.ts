 ...
 */
export function searchSearchParameters(
  client: BereachCore,
  request: operations.SearchParametersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SearchParametersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.SearchParametersRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SearchParametersResponse$inboundSchema),
